...
namespace QTRecorder
{
	public partial class QTRDocument : MonoMac.AppKit.NSDocument
	{
		...
		// mike: 
		QTRCaptureDecompressedVideoOutput decompressedVideoOuput;
		...
		public override void WindowControllerDidLoadNib (NSWindowController windowController)
		{
			...
			decompressedVideoOuput = new QTRCaptureDecompressedVideoOutput();
			NSError error2;
//			decompressedVideoOuput.DidOutputVideoFrame += (sender, e) => 
//			{
//				// var frame = e.SampleBuffer;
//				Console.WriteLine("---- DidOutputVideoFrame");
//			};
		...
		partial void _takePhotoClick (MonoMac.Foundation.NSObject sender)
		{
			...
			decompressedVideoOuput.Capture();
		}
	}
}
